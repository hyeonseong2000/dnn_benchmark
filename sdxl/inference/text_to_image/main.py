...
def get_args():
    ...
    parser.add_argument("--count", type=int, default=5000, help="dataset items to use")
...
def main():
    ...
    # warmup
    syntetic_str = "A beautiful landscape with mountains and rivers"
    ...
    print("warmup stage start...")
    for i in range(2):
        _ = backend.predict(warmup_samples)
    print("warmup stage fininsh !")
